...
import fabiocarlino.gestione_eventi.exceptions.UnauthorizedException;
...
public class JWTTools {
    ...
    public String generateToken(Utente utente) {
        return Jwts.builder()
                ...
                .subject(String.valueOf(utente.getIdUtente())) // Subject cioè a chi appartiene il token. Ci inseriamo l'id dell'utente (MAI METTERE DATI SENSIBILI AL SUO INTERNO)
